export type EGALicenseKind = "evaluation" | "commercial";
export type EGALicenseStatus = "active" | "expiring" | "expired" | "suspended";
...
export type EGALicense = EGAEvaluationLicense | EGACommercialLicense;
